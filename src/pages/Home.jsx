...
<section className="relative py-28 border-t border-white/5 overflow-hidden">
  ...
  <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
    ...
    {/* CARD 1 — SPEED (Clock icon = better than Zap) */}
    ...
    {/* CARD 2 — TRUST (Shield Check = stronger than generic shield) */}
    ...
    {/* CARD 3 — MONEY (Trending down = stronger than Euro icon) */}
  ...
  {/* MINI CTA (important for conversions) */}
  <div className="mt-14 text-center">
    ...
    <a href="/quote"
       className="inline-flex px-6 py-3 rounded-xl bg-blue-500 text-white font-semibold hover:bg-blue-400 transition shadow-lg hover:shadow-blue-500/30">
      Start comparison
    </a>
  </div>
