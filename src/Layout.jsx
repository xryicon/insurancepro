...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* NEW FOOTER (replace the old footer with this) */}
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-400 text-sm">
              Website: <a href="https://yourwebsite.com" className="text-blue-400 hover:text-white">www.insurancepro.es</a>
            </p>
          </div>
          ...
          <div className="text-center mb-6">
            ...
            <div className="flex justify-center space-x-6">
              <a href="/faq" onClick={(e) => { e.preventDefault(); navigate('/faq'); }} className="text-gray-400 hover:text-white transition-colors text-sm">
                FAQ
              </a>
              <a href="/privacy-policy" onClick={(e) => { e.preventDefault(); navigate('/privacy-policy'); }} className="text-gray-400 hover:text-white transition-colors text-sm">
                Privacy Policy
              </a>
            </div>
          </div>
